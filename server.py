...
def login():
    ...
    password_hash = hash_password(password)
    c.execute('SELECT id, is_admin FROM accounts WHERE username = ? AND password_hash = ?',
...
if __name__ == '__main__':
    ...
    # Initialize database
    init_db()
    # Ensure primary admin account has admin flag (change username if needed)
    promote_to_admin("Roy Folker")
